...
class HorizontalResidencePatternMatcherTest {
    ...
    private final String label2 = "075414799-01\n" +
            ...
            "João da Silva\n" +
            "D\n" +
            "Avenida Carlos Block, 2691 - Casa34\n" +
            "anhangabaú - 13205101\n" +
            "JUNDIAI, SP";
    private final String label3 = "15/03/2023, 08:46\n" +
            ...
            "DESTINATÁRIO\n" +
            "JOSÉ PAULO\n" +
            "AVENIDA SANTO AMARO, 9416 - Casa 11a\n" +
    ...
    private final String labelWithoutHouseNumber = "Remetente\n" +
            "GRUB-Amazon Serviços de Varejo Ltda.\n" +
            "AVENIDA DOUTOR ANTONIO JOÃO ABDALA, Nº: 2010\n" +
            "Cajamar SP 07750820\n" +
            "Brazil\n" +
    ...
    @InjectMocks
    private HorizontalResidencePatternMatcher matcher;

    @Test
    void shouldRecognizeHouseNumber() {
        final String expectedPatternLabel1 = "CASA 4";
        final String expectedPatternLabel2 = "Casa34";
        final String expectedPatternLabel3 = "Casa 11a";
        final String expectedPatternLabel4 = "CASAN13";
        final String expectedPatternLabel5 = "casa A12731c";
    ...
    void shouldThrowResidenceDetailsNotFoundException() {
        assertThrows(ResidenceDetailsNotFoundException.class,
                () -> matcher.matchResidencePattern(labelWithoutHouseNumber));
    }

    @Test
    void getCondominiumType() {
        assertSame(matcher.getCondominiumType(), CondominiumType.HORIZONTAL);
    }
